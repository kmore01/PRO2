...
public:
  ...
  class iterator {
    ...
    {
      if (isEntangle) {
          if (whichEntangle->pitem != &(whichEntangle->plist->itemsup)) {
            whichEntangle->pitem = whichEntangle->pitem->next;
          }
      }
    ...
    {
      if (isEntangle) {
          if (whichEntangle->pitem != whichEntangle->plist->iteminf.next) {
            whichEntangle->pitem = whichEntangle->pitem->prev;
          }
      }
